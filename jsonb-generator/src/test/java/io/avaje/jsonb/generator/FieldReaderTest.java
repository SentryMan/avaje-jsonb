...
class FieldReaderTest {
  ...
  void trimAnnotations() {
    ...
    assertEquals(
        "java.lang.String",
        FieldReader.trimAnnotations("java.lang.@javax.validation.constraints.Email String"));
    assertEquals(
        "java.lang.String",
        FieldReader.trimAnnotations(
            "java.lang.@javax.validation.constraints.NotNull,@javax.validation.constraints.Size(min=2, max=150) String"));
    assertEquals(
        "java.lang.String",
        FieldReader.trimAnnotations(
            "java.lang.@javax.validation.constraints.Email,@javax.validation.constraints.Size(max=100) String"));
  }
}
