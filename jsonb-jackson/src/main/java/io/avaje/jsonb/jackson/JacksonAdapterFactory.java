 ...
 *
 * <p>Uses jackson code to do the underlying json parsing and generation.
 */
public class JacksonAdapterFactory implements AdapterFactory {

  @Override
  public JsonStreamAdapter create(
      boolean serializeNulls, boolean serializeEmpty, boolean failOnUnknown) {
