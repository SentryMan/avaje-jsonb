 ...
 *
 * <p>The {@link #available()} method of this class always returns 0. The methods {@link #mark(int)}
 * and {@link #reset()} are not supported.
 *
...
final class ReaderInputStream extends InputStream {
   ...
   *
   * <p>The encoder created for the specified charset will use {@link CodingErrorAction#REPLACE} for
   ...
   * Constructs a new {@link ReaderInputStream}.
   *
   * <p>This constructor does not call {@link CharsetEncoder#reset() reset} on the provided encoder.
   * The caller of this constructor should do this when providing an encoder which had already been
   * in use.
   *
   * @param reader the target {@link Reader}
